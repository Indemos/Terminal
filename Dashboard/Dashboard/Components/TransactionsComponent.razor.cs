...
namespace Dashboard.Components
{
  public partial class TransactionsComponent
  {
    ...
    public virtual async void Update(IEnumerable<IGateway> adapters, TransactionCriteria criteria = default)
    {
      ...
      var queries = adapters.Select(o => o.GetTransactions(criteria));
