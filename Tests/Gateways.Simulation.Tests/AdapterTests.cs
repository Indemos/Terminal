...
namespace Simulation.Tests
{
  ...
  public class AdapterTests : IDisposable
  {
    ...
    private readonly string _descriptor = "{ \"Account\": \"Demo\" }";
    ...
    public AdapterTests()
    {
      ...
      _mockAdapter.Setup(o => o.OrderStream).Returns(mockOrderStream.Object);
      _mockAdapter.Setup(o => o.Stream).Returns(mockStream.Object);
    ...
    public async Task Connect_ShouldReturnActiveStatus()
    {
      ...
      _mockConnectionGrain.Verify(o => o.StoreInstruments(It.IsAny<Dictionary<string, InstrumentState>>()), Times.Once);
      _mockConnectionGrain.Verify(o => o.Connect("demo-source", 500), Times.Once);
    }
    ...
    public async Task GetDom_ShouldReturnDomResponse()
    {
      ...
      var grain = _cluster
        .GrainFactory
        .GetGrain<IDomGrain>(_descriptor);
    ...
    public async Task GetBars_WithDateFilters_ShouldReturnFilteredPrices()
    {
      ...
      var grain = _cluster
        .GrainFactory
        .GetGrain<IPricesGrainAdapter>(_descriptor);

      foreach (var price in priceData)
      {
        await grain.Add(price);
      }
    ...
    public async Task GetOptions_WithStrikeFilters_ShouldReturnFilteredOptions()
    {
      ...
      var grain = _cluster
        .GrainFactory
        .GetGrain<IOptionsGrainAdapter>(_descriptor);
    ...
    public async Task GetOrders_ShouldReturnOrdersResponse()
    {
      ...
      var grain = _cluster
        .GrainFactory
        .GetGrain<IOrdersGrain>(_descriptor);
    ...
    public async Task GetPositions_ShouldReturnPositionsResponse()
    {
      ...
      var grain = _cluster
        .GrainFactory
        .GetGrain<IPositionsGrain>(_descriptor);
    ...
    public async Task GetTransactions_ShouldReturnTransactionsResponse()
    {
      ...
      var grain = _cluster
        .GrainFactory
        .GetGrain<ITransactionsGrain>(_descriptor);
