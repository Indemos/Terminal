...
namespace Simulation
{
  public class Reader : IDisposable
  {
    ...
    /// Descriptor
    /// </summary>
    public virtual DescriptorState Descriptor { get; set; }
    ...
    public virtual StatusResponse Connect()
    {
      ...
      streams = (instruments = Adapter.Account.Instruments.Concurrent()).ToDictionary(
        o => o.Value.Name,
        o => Directory
      ...
      instruments.Values.ForEach(o => Subscribe(o));
    ...
    {
      instruments?.Values?.ForEach(o => Unsubscribe(o));
    ...
    public virtual StatusResponse Subscribe(InstrumentState instrument)
    {
      ...
      var pricesGrain = Adapter.Connector.Get<ISimPricesGrain>(instrumentDescriptor);
    ...
    /// </summary>
    /// <param name="instrument"></param>
    public virtual StatusResponse Unsubscribe(InstrumentState instrument)
    {
