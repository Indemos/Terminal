...
namespace Terminal.Tests
{
  public class IncreasePosition : Adapter, IDisposable
  {
    ...
    //  var order = base.CorrectOrder(new OrderModel
    //  {
    ...
    private (OrderModel, InstrumentModel) CreatePositions()
    {
      ...
      var orderX = new OrderModel
      {
        ...
        Type = OrderTypeEnum.Market,
        Transaction = new() { CurrentVolume = 1, Instrument = instrumentX }
      };
      ...
      var orderY = new OrderModel
      {
        Side = OrderSideEnum.Buy,
        Type = OrderTypeEnum.Market,
        Transaction = new() { CurrentVolume = 1, Instrument = instrumentY }
      };
